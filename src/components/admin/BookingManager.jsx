...
const BookingManager = () => {
  ...
  const updateBookingStatusMut = useMutation(api.bookings.updateStatus);
  ...
  const updateBookingStatus = async (id, status) => {
    try {
      setMessage(null);
      await updateBookingStatusMut({ id, status });
  ...
  const formatDate = (value) => {
    ...
    try {
      // Handle both ISO strings and ms timestamps (_creationTime)
        ...
        <div className="bg-gray-700 p-6 rounded-lg mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <p className="font-medium text-white">{selectedBooking.serviceType}</p>
            </div>
            <div>
              <p className="text-sm text-gray-400">Requested Date</p>
              <p className="font-medium text-white">{formatDate(selectedBooking.requestedDate)}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium text-white">{formatDate(selectedBooking._creationTime)}</p>
            </div>
            ...
            <tbody className="bg-gray-800 divide-y divide-gray-600">
              {bookings.map((booking) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-white">{formatDate(booking.requestedDate)}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">
                    {formatDate(booking._creationTime)}
                  </td>
